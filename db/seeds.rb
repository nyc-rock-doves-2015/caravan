...
dt9 = Trip.create(origin_address: nyaddress4, destination_address: sf4, driver_id: 4, leaving_at: "2015-05-22 18:36:59 -0400", arriving_at: "2015-05-24 18:36:59 -0400", available_volume: rand(10..400), 45, rate: Faker::Commerce.price , content_restrictions: "Passengers Welcome", vehicle: "Sprinter")
dt10 = Trip.create(origin_address: nyaddress5, destination_address: sf5, driver_id: 5, leaving_at: "2015-05-19 18:36:59 -0400", arriving_at: "2015-05-24 18:36:59 -0400", available_volume: 5, max_weight: 120, rate: Faker::Commerce.price , content_restrictions: "Passengers Welcome", vehicle: "Minivan")
dt11 = Trip.create(origin_address: nyaddress1, destination_address: sf6, driver_id: 6, leaving_at: "2015-05-19 18:36:59 -0400", arriving_at:  "2015-05-24 18:36:59 -0400", available_volume: rand(10..400), max_weight: 140, rate: Faker::Commerce.price , content_restrictions: "Pets allowed", vehicle: "Minivan")
dt12 = Trip.create(origin_address: nyaddress2, destination_address: sf7, driver_id: 2, leaving_at: "2015-05-19 18:36:59 -0400", arriving_at:  "2015-05-23 18:36:59 -0400", available_volume: 25, max_weight: 30, rate: Faker::Commerce.price , content_restrictions: "Pets allowed", vehicle: "U-Haul")
dt13 = Trip.create(origin_address: nyaddress3, destination_address: sf8, driver_id: 3, leaving_at: "2015-05-19 18:36:59 -0400", arriving_at:  "2015-05-23 18:36:59 -0400", available_volume: 30, max_weight: 40, rate: Faker::Commerce.price , content_restrictions: "Cardboard parcels only", vehicle: "U-Haul")
dt14 = Trip.create(origin_address: nyaddress4, destination_address: sf9, driver_id: 4, leaving_at: "2015-05-19 18:36:59 -0400", arriving_at:  "2015-05-24 18:36:59 -0400", available_volume: 13, max_weight: 21, rate: Faker::Commerce.price , content_restrictions: "No dogs allowed", vehicle: "Ferrari")
