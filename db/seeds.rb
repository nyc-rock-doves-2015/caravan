...
dt3 = Trip.create(origin_address: nyaddress3, destination_address: da3, driver_id: 3, leaving_at: Faker::Date.forward(3), arriving_at: Faker::Date.forward(10), available_volume: rand(10..400), max_weight: rand(1..200), rate: 0.50 , content_restrictions: "No flammables", vehicle: "10-ft Uhaul")

dt4 = Trip.create(origin_address: nyaddress4, destination_address: da4, driver_id: 4, leaving_at: Faker::Date.forward(3), arriving_at: Faker::Date.forward(10), available_volume: rand(10..400), max_weight: rand(1..200), rate: 0.50 , content_restrictions: "No flammables", vehicle: "Escalade")
