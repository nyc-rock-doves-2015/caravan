...
da3 = Address.create(description: "Be careful on the stairs", street_address: "4878 Jendrejas Rd", secondary_address: "Apartment 5", city: "North Little Rock", state: "AR", zip_code: 72118, user_id: 29)
...
dt6 = Trip.create(origin_address: nyaddress1, destination_address: sf1, driver_id: 6, leaving_at: "2015-05-13 18:36:59 -0400", arriving_at: Faker::Date.forward(10), available_volume: rand(10..400), max_weight: rand(1..200), rate: Faker::Commerce.price , content_restrictions: "No food", vehicle: "F-150")

dt7 = Trip.create(origin_address: nyaddress2, destination_address: sf2, driver_id: 2, leaving_at: "2015-05-14 18:36:59 -0400", arriving_at: Faker::Date.forward(10), available_volume: rand(10..400), max_weight: rand(1..200), rate: Faker::Commerce.price , content_restrictions: "Not responsible for lost or stolen items", vehicle: "Truck")

dt8 = Trip.create(origin_address: nyaddress3, destination_address: sf3, driver_id: 3, leaving_at: "2015-05-15 18:36:59 -0400", arriving_at: Faker::Date.forward(10), available_volume: rand(10..400), max_weight: rand(1..200), rate: Faker::Commerce.price , content_restrictions: "Not responsible for lost or stolen items", vehicle: "U-Haul")
dt9 = Trip.create(origin_address: nyaddress4, destination_address: sf4, driver_id: 4, leaving_at: "2015-05-14 18:36:59 -0400", arriving_at: "2015-05-27 18:36:59 -0400", available_volume: rand(10..400), max_weight: rand(1..200), rate: Faker::Commerce.price , content_restrictions: "Passengers Welcome", vehicle: "Sprinter")
dt10 = Trip.create(origin_address: nyaddress5, destination_address: sf5, driver_id: 5, leaving_at: "2015-05-14 18:36:59 -0400", arriving_at: "2015-05-18 18:36:59 -0400", available_volume: rand(10..400), max_weight: rand(1..200), rate: Faker::Commerce.price , content_restrictions: "Passengers Welcome", vehicle: "Minivan")
dt11 = Trip.create(origin_address: nyaddress1, destination_address: sf6, driver_id: 6, leaving_at: "2015-05-14 18:36:59 -0400", arriving_at:  "2015-05-29 18:36:59 -0400", available_volume: rand(10..400), max_weight: rand(1..200), rate: Faker::Commerce.price , content_restrictions: "Pets allowed", vehicle: "Minivan")
dt12 = Trip.create(origin_address: nyaddress2, destination_address: sf7, driver_id: 2, leaving_at: "2015-05-14 18:36:59 -0400", arriving_at:  "2015-05-27 18:36:59 -0400", available_volume: rand(10..400), max_weight: 50, rate: Faker::Commerce.price , content_restrictions: "Pets allowed", vehicle: "U-Haul")
dt13 = Trip.create(origin_address: nyaddress3, destination_address: sf8, driver_id: 3, leaving_at: "2015-05-14 18:36:59 -0400", arriving_at:  "2015-05-27 18:36:59 -0400", available_volume: rand(10..400), max_weight: 50, rate: Faker::Commerce.price , content_restrictions: "Cardboard parcels only", vehicle: "U-Haul")
dt14 = Trip.create(origin_address: nyaddress4, destination_address: sf9, driver_id: 4, leaving_at: "2015-05-14 18:36:59 -0400", arriving_at:  "2015-05-27 18:36:59 -0400", available_volume: 13, max_weight: 50, rate: Faker::Commerce.price , content_restrictions: "No dogs allowed", vehicle: "Ferrari")
